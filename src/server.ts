 ...
 *
 * All tools, helpers, and server instance shared between the stdio
 * entry point (index.ts) and the HTTP entry point (http.ts).
 *
...
export const METICULOUS_IP = MACHINE_IP;
